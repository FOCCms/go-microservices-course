...
func (_mock *UserRepository) GetByUUID(ctx context.Context, uuid1 uuid.UUID) (model.User, error) {
...
//   - ctx context.Context
//   - uuid1 uuid.UUID
func (_e *UserRepository_Expecter) GetByUUID(ctx interface{}, uuid1 interface{}) *UserRepository_GetByUUID_Call {
	return &UserRepository_GetByUUID_Call{Call: _e.mock.On("GetByUUID", ctx, uuid1)}
}

func (_c *UserRepository_GetByUUID_Call) Run(run func(ctx context.Context, uuid1 uuid.UUID)) *UserRepository_GetByUUID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *UserRepository_GetByUUID_Call) RunAndReturn(run func(ctx context.Context, uuid1 uuid.UUID) (model.User, error)) *UserRepository_GetByUUID_Call {
	_c.Call.Return(run)
	return _c
}
