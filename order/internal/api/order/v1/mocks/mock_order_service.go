...
func (_mock *OrderService) Create(ctx context.Context, req model.CreateOrderRequest) (model.Order, error) {
...
func (_c *OrderService_Create_Call) RunAndReturn(run func(ctx context.Context, req model.CreateOrderRequest) (model.Order, error)) *OrderService_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function for the type OrderService
func (_mock *OrderService) Get(ctx context.Context, id uuid.UUID) (model.Order, error) {
...
//   - ctx context.Context
//   - id uuid.UUID
func (_e *OrderService_Expecter) Get(ctx interface{}, id interface{}) *OrderService_Get_Call {
	return &OrderService_Get_Call{Call: _e.mock.On("Get", ctx, id)}
}

func (_c *OrderService_Get_Call) Run(run func(ctx context.Context, id uuid.UUID)) *OrderService_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrderService_Get_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (model.Order, error)) *OrderService_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Pay provides a mock function for the type OrderService
func (_mock *OrderService) Pay(ctx context.Context, id uuid.UUID, method model.PaymentMethod) (uuid.UUID, error) {
...
func (_e *OrderService_Expecter) Pay(ctx interface{}, id interface{}, method interface{}) *OrderService_Pay_Call {
	return &OrderService_Pay_Call{Call: _e.mock.On("Pay", ctx, id, method)}
}

func (_c *OrderService_Pay_Call) Run(run func(ctx context.Context, id uuid.UUID, method model.PaymentMethod)) *OrderService_Pay_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrderService_Pay_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID, method model.PaymentMethod) (uuid.UUID, error)) *OrderService_Pay_Call {
	_c.Call.Return(run)
	return _c
}
